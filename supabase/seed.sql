...
values
  ('00000000-0000-0000-0000-000000000001', 'sora_desk', 'sora@hkdvtrade.local', true, 'Sora Desk', 'seed-passcode', 'active', '/assets/avatars/buddy_variants/charm/avatar_charm_hooded.png', 'progress_pride', 'my_melody', 'My Melody', 'Strawberry Cake', 'HKDV-SORA-041', true, 4, 23, true, '2026-04-01T09:00:00Z'),
  ('00000000-0000-0000-0000-000000000002', 'mika_mirror', 'mika@hkdvtrade.local', false, 'Mika Mirror', 'seed-passcode', 'active', '/assets/avatars/buddy_variants/charm/avatar_charm_hooded.png', 'lesbian', 'my_melody', 'My Melody', 'Strawberry Parfait', 'HKDV-MIKA-112', false, 5, 8, true, '2026-04-02T09:00:00Z'),
  ('00000000-0000-0000-0000-000000000003', 'hana_collects', 'hana@hkdvtrade.local', false, 'Hana Collects', 'seed-passcode', 'active', '/assets/avatars/buddy_variants/charm/avatar_charm_puppy.png', 'bisexual', 'pompompurin', 'Pompompurin', 'Strawberry Parfait', null, false, 11, 27, true, '2026-04-04T09:00:00Z'),
  ('00000000-0000-0000-0000-000000000004', 'emi_events', 'emi@hkdvtrade.local', false, 'Emi Events', 'seed-passcode', 'invited', '/assets/avatars/buddy_variants/charm/avatar_charm_hooded.png', null, 'kuromi', 'Kuromi', 'Strawberry Milk', null, false, null, null, false, null),
  ('00000000-0000-0000-0000-000000000005', 'rin_bagrun', 'rin@hkdvtrade.local', false, 'Rin Bag Run', 'seed-passcode', 'suspended', '/assets/avatars/buddy_variants/charm/avatar_charm_puppy.png', 'transgender', 'cinnamoroll', 'Cinnamoroll', 'Strawberry Cookie', null, false, 2, 12, true, '2026-04-05T09:00:00Z')
